<x-app-layout>
    ...
    <div class="container py-5 w-75 mx-auto">
        <!-- Page Title -->
        <h1 class="mb-4 text-center">Create Invoice</h1>
        <p class="mb-6 text-muted text-center">Generate professional invoices in minutes</p>
        ...
        <form action="{{ route('invoices.store') }}" method="POST" enctype="multipart/form-data" id="invoiceForm">
            ...
            <div class="card mb-5 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="business_name" name="business_name" required placeholder="Your Business Name" value="{{ old('business_name') }}">
                    </div>

                    <div class="mb-3">
                        <label for="business_email" class="form-label">Business Email *</label>
                        <input type="email" class="form-control" id="business_email" name="business_email" required placeholder="business@example.com" value="{{ old('business_email') }}">
                    </div>

                    <div class="mb-3">
                        <label for="business_address" class="form-label">Business Address</label>
                        <textarea class="form-control" id="business_address" name="business_address" rows="2" placeholder="Street Address, City, State, ZIP">{{ old('business_address') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="invoice_number" name="invoice_number" value="INV-{{ time() }}" readonly>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="client_address" name="client_address"
                            placeholder="Client Address">{{ old('client_address') }}</textarea>
                    </div>
            ...
            <div class="card mb-5 shadow-sm">
                <div class="card-body">
                    ...
                    <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Payment terms, additional information, etc.">{{ old('notes') }}</textarea>
                </div>
            </div>

            <!-- Submit + Preview Buttons -->
            <div class="d-flex justify-content-center gap-3">
                <button type="submit" class="btn btn-primary btn-lg px-5">Create Invoice</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            //     // Temporarily show hidden elements if needed
